...
TEST_CASE("headers match the linked library") { CHECK(las::abi_compatible()); }
...
TEST_CASE("Format::new rejects invalid numbers") { CHECK_THROWS_AS(las::point::Format(11), las::Error); }
